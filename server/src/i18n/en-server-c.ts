...
export const enServerC: Record<string, string> = {
  ...
  "——{guidance}": " — {guidance}",
  "✅ 自動循環已達步數上限，已自動停止。要繼續就再打開開關。": "✅ Autopilot reached its step limit and stopped. Switch it back on to continue.",
  "✅ 自動循環已達時間上限，已自動停止。要繼續就再打開開關。": "✅ Autopilot reached its time limit and stopped. Switch it back on to continue.",
  "🅿️ 自動循環正常結束{reason}。要再交辦就打開開關或直接下指令。": "🅿️ Autopilot finished normally{reason}. Switch it on again or give an instruction to assign more work.",
  "：{reason}": ": {reason}",
