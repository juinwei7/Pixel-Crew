...
export const enRoot: Record<string, string> = {
  // approvalPlain.ts
  "執行指令：{cmd}": "Running: {cmd}",
  "執行指令": "Running a command",
  "編輯 {file}": "Editing {file}",
  "編輯程式碼": "Editing code",
  "讀取 {file}": "Reading {file}",
  "讀取檔案": "Reading a file",
  "上網查：{q}": "Searching the web: {q}",
  "上網搜尋": "Searching the web",
  "搜尋：{p}": "Searching: {p}",
  "搜尋程式碼": "Searching the code",
  "找檔案：{p}": "Finding files: {p}",
  "找檔案": "Finding files",
  "派發子任務…": "Handing out subtasks…",
  "整理待辦清單…": "Tidying the to-do list…",
  "呼叫 {tool}…": "Calling {tool}…",
  "需要主人授權": "Owner approval needed",
  "這個操作會動到既有或重要資料，請輸入監護密碼才能繼續。":
    "This touches existing or important data. Enter the guardian password to continue.",
  "解鎖並繼續": "Unlock and continue",
  "請輸入監護密碼": "Enter the guardian password",
  "驗證中…": "Checking…",
  "嘗試過於頻繁，請約 {mins} 分鐘後再試": "Too many attempts. Try again in about {mins} minutes.",
  "主人尚未設定監護密碼，無法執行此操作。": "The owner hasn't set a guardian password, so this can't be done.",
  "監護密碼錯誤": "Wrong guardian password",
  "連線失敗，請重試": "Connection failed. Try again.",
