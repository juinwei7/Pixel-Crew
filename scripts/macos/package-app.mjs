...
// Generated by `npm run icons` and committed; without it Finder falls back to
// the blank generic-application icon for every download.
const appIcon = join(root, "assets", "icons", "pixel-crew.icns");
await requireFile(appIcon, "app icon");
